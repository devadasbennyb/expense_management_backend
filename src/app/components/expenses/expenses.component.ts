...
import { expenseData } from './expenses.model';
import { DropDownList } from '../home-page/home-page.model';
...
export class ExpensesComponent implements OnInit {
  ...
  addExpenses() {
    ...
    this.expenseDataObj.chooseFile = this.formValue.value.chooseFile;
  ...
  editExpense(data: any) {
    ...
    this.expId = false;
    this.expenseDataObj.expId = data.expId;
    this.formValue.controls['empId'].setValue(data.empId);
    this.formValue.controls['expenseName'].setValue(data.expenseName);
    this.formValue.controls['expTypeId'].setValue(data.expTypeId);
    this.formValue.controls['merchant'].setValue(data.merchant);
    this.formValue.controls['description'].setValue(data.description);
    this.formValue.controls['paymentId'].setValue(data.paymentId);
    this.formValue.controls['currency'].setValue(data.currency);
    this.formValue.controls['amount'].setValue(data.amount);
    this.formValue.controls['chooseFile'].setValue(data.chooseFile);
  }
  updateExpense() {
    this.expenseDataObj.empId = this.formValue.value.empId;
    this.expenseDataObj.expenseName = this.formValue.value.expenseName;
  ...
  deleteExpense(data: any) {
    this.service.deleteExpenseData('expense_details/', data.expId).subscribe({
      next: (res) => {
