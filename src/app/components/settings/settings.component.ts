...
import { DropDownList } from 'src/app/components/settings/settings.model';
...
export class SettingsComponent implements OnInit {
  // showComponentTrips!:boolean
  // showComponentAdvances!:boolean
  // showAdvances!:boolean
  // showTrips!:boolean
  constructor() {}

  ngOnInit(): void {}
  // For enabling or DIsable TRIP and ADVACE tabs

  // clickSettings()
  // {
  //   this.showComponentTrips=false;
  //   this.showComponentAdvances=false;
  // }
  // clickEnableAdvances()
  // {
  //   this.showAdvances=true;
  //   this.showComponentAdvances=true;
  // }
  // clickEnableTrips()
  // {
  //   this.showTrips=true;
  //   this.showComponentTrips=true;
  // }
  // clickDisableAdvances()
  // {
